...
COPY ["LoginBusinessLogic/LoginBusinessLogic.csproj", "LoginBusinessLogic/"]
COPY ["LoginModels/LoginModels.csproj", "LoginModels/"]
COPY ["PatientLoginFluentApi/PatientLoginFluentApi.csproj", "PatientLoginFluentApi/"]
